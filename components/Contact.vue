<template>
  ...
  <section class="py-12 md:py-16 px-4 sm:px-6">
    <div class="max-w-2xl mx-auto">
      <p class="text-center font-mono text-xs tracking-wide text-[#4caf50] mb-2">iletişim</p>
      <h2 class="text-3xl md:text-4xl font-bold mb-4 text-center font-display">Benimle iletişime geç</h2>
      <p class="text-center mb-8 md:mb-10 text-base md:text-lg text-gray-400">
...
const sendMail = async () => {
  ...
  try {
    // EmailJS API çağrısı
    await $emailjs.send(
      "service_4oo75mn",     // EmailJS Service ID
      "template_bw3owcl",    // EmailJS Template ID
      {
        ...form.value,
        to_email: "orucbertan7@gmail.com", // Mesajın gideceği adres
      },
