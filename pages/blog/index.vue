<template>
  <div class="max-w-6xl mx-auto px-4 md:px-6 pt-10 pb-4">
    <p class="eyebrow mb-2">projeler &amp; yazılar</p>
    <h1 class="text-3xl md:text-4xl font-display font-bold mb-8">Blog &amp; Projelerim</h1>
...
/* İçerik yalnızca hover destekleyen (mouse'lu) cihazlarda gizli başlar;
   dokunmatik/mobil cihazlarda içerik her zaman görünür kalır. */
@media (hover: hover) {
  .card-inner,
  .card-inner-1 {
    opacity: 0;
...
.card::after {
  ...
  position: absolute;
  inset: -30%;
  background: radial-gradient(circle at 50% 10%, rgba(76,175,80,0.08), transparent 10%),
              radial-gradient(circle at 80% 90%, rgba(76,175,80,0.04), transparent 20%);
  opacity: 0;
